...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 26 11:35:57 2018
"""
...
iters = list(range(lastIterMin - 1))
iters2 = list(range(lastIterMin - 1))
plt.semilogy(Vmean[0:-1], linewidth=2, linestyle="-", marker="^", markersize=13, markevery=2)
plt.fill_between(iters, VLow[0:-1], VHigh[0:-1], color="#d9e6f2", label="95% CI")

plt.semilogy(V2[0:-1], linewidth=2, color="k", linestyle="--")
